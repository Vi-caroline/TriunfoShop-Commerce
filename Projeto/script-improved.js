...
class TriunfoShop {
    ...
    loadSampleProducts() {
        this.products = [
            ...
            { id: '9', name: 'Bola de Futebol Adidas', description: 'Bola oficial para treinos e partidas', category: 'esportes', price: 129.99, stock: 10, image: 'https://th.bing.com/th?id=OIF.RTDSECphKTxfD2ydm%2bLqPA&rs=1&pid=ImgDetMain&o=7&rm=3', status: 'active', rating: 4.5 },
            ...
            { id: '24', name: 'Bola de Basquete Spalding', description: 'Bola oficial para quadra', category: 'esportes', price: 149.99, stock: 10, image: 'https://tse4.mm.bing.net/th/id/OIF.EGMjTygQ6JmTR8G4c5UvKw?rs=1&pid=ImgDetMain&o=7&rm=3', status: 'active', rating: 4.5 },
    ...
    updateCartCount() {
        // Suporte tanto para 'qtd' quanto 'quantity' e previne NaN
        const cartCount = Array.isArray(this.cart)
            ? this.cart.reduce((total, item) => {
                const qtd = typeof item.qtd === 'number' ? item.qtd : (typeof item.quantity === 'number' ? item.quantity : 0);
...
// Logout automático se perfil não for Cliente ou Admin na home
try {
